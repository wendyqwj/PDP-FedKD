...
def args_parser():
    ...
    parser.add_argument('--avg', action='store_true', help="fedavg or fedweightavg")
    ...
    parser.add_argument('--record_round', type=int, default=10, help="每训练多少轮, 记录一次数据至log")
    ...
    # parser.add_argument('--serial_bs', type=int, default=10, help='partial serial running batch size')
