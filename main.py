...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        t_end = time.time()
        print("Round {:3d},Testing accuracy: {:.2f}, Time taken:  {:.2f}s".format(iter, acc_t, t_end - t_start))
    ...
    accfile = open(rootpath + '/accfile_fed_{}_{}_{}_iid{}_dp_{}_epsilon_{}_{}.dat'.
                   format(args.dataset, args.model, args.epochs, args.iid,
                          args.dp_mechanism, args.dp_epsilon, datetime.now().strftime('%Y-%m-%d-%H-%M-%S')), "w")
    ...
    plt.savefig(rootpath + '/fed_{}_{}_{}_C{}_iid{}_dp_{}_epsilon_{}_acc_{}.png'.format(
        args.dataset, args.model, args.epochs, args.frac, args.iid, args.dp_mechanism, args.dp_epsilon, datetime.now().strftime('%Y-%m-%d-%H-%M-%S')))