python3 -u main.py --dataset mnist --dp_mechanism Gaussian --dp_epsilon 30 --dp_clip 10 --gpu 2
...
python3 -u main.py --dataset mnist --dp_mechanism Gaussian --dp_epsilon 1 --dp_clip 10 --gpu 2
python3 -u main.py --dataset mnist --dp_mechanism no_dp --gpu 2


python3 -u main.py --dataset mnist --dp_mechanism MA --dp_epsilon 30 --dp_clip 10 --gpu 2 --dp_sample 0.01
...
python3 -u main.py --dataset mnist --dp_mechanism MA --dp_epsilon 1 --dp_clip 10 --gpu 2 --dp_sample 0.01
